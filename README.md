...
If you are using a version of this client hosted by someone else, you have no way to verify that the source has not been tampered with. This applies equally to any Dalamud plugin, Aetherlove included. 
