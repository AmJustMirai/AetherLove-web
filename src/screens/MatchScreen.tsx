...
export function MatchScreen() {
    ...
    return (
        <div className="absolute inset-0 flex items-center justify-center p-4">
            <div
                className="relative aspect-[464/835] h-full max-h-[860px] w-auto max-w-full overflow-hidden rounded-[28px] border border-line/10 shadow-[0_30px_90px_-30px_rgb(var(--al-accent)/0.6)]">
