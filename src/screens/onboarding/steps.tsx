...
export function StepWelcome({ t }: StepProps) {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-5 text-center">
      <span className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-[rgb(var(--al-secondary-start))]/30 to-[rgb(var(--al-secondary-end))]/30 text-accent ring-1 ring-accent/30">
