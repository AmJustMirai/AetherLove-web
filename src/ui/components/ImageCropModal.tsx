...
export function ImageCropModal({open, img, kind, onConfirm, onCancel}: ImageCropModalProps) {
    ...
    const onPointerMoveShared = useCallback((e: React.PointerEvent) => {
                ...
                >
                    <div ref={containerRef} className="relative flex-1 overflow-hidden">
                        ...
                        >
                            ...
                            <rect x={cx + cw} y={cy} width={dispW - cx - cw} height={ch} fill="rgba(0,0,0,0.55)"/>
                            <rect x={0} y={cy + ch} width={dispW} height={dispH - cy - ch} fill="rgba(0,0,0,0.55)"/>
                            <rect x={cx} y={cy} width={cw} height={ch} fill="none" stroke="rgba(255,255,255,0.85)"
                                  strokeWidth="1.5"/>
                            {/* Top-left corner */}
                            <line x1={cx} y1={cy} x2={cx + tick} y2={cy} stroke="white" strokeWidth="3"
                                  strokeLinecap="round"/>
                            <line x1={cx} y1={cy} x2={cx} y2={cy + tick} stroke="white" strokeWidth="3"
                                  strokeLinecap="round"/>
                            {/* Top-right corner */}
                            <line x1={cx + cw} y1={cy} x2={cx + cw - tick} y2={cy} stroke="white" strokeWidth="3"
                                  strokeLinecap="round"/>
                            <line x1={cx + cw} y1={cy} x2={cx + cw} y2={cy + tick} stroke="white" strokeWidth="3"
                                  strokeLinecap="round"/>
                            {/* Bottom-left corner */}
                            <line x1={cx} y1={cy + ch} x2={cx + tick} y2={cy + ch} stroke="white" strokeWidth="3"
                                  strokeLinecap="round"/>
                            <line x1={cx} y1={cy + ch} x2={cx} y2={cy + ch - tick} stroke="white" strokeWidth="3"
                                  strokeLinecap="round"/>
                        </svg>
